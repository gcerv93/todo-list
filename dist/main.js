...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "displayBottomNavDivs": () => (/* binding */ displayBottomNavDivs),
/* harmony export */   "bottomNavStuff": () => (/* binding */ bottomNavStuff)
/* harmony export */ });
/* harmony import */ var _divTemplates_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./divTemplates.js */ "./src/divTemplates.js");
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers.js */ "./src/helpers.js");
/* harmony import */ var _objStuff_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./objStuff.js */ "./src/objStuff.js");
/* harmony import */ var _taskDisplay_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./taskDisplay.js */ "./src/taskDisplay.js");
...
const handleTaskFormSubmits = () => {
  ...
  const project = _objStuff_js__WEBPACK_IMPORTED_MODULE_2__.projectManager.getProject(hiddenInput.value);

  const task = (0,_objStuff_js__WEBPACK_IMPORTED_MODULE_2__.taskFactory)(taskName.value, desc.value, (0,date_fns_parse__WEBPACK_IMPORTED_MODULE_4__["default"])(dueDate.value, 'yyyy-MM-dd', new Date()), false, false);
  ...
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.clearTasks)();
  (0,_taskDisplay_js__WEBPACK_IMPORTED_MODULE_3__["default"])(project, true);
  (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.saveStorage)();
};
...
const displayBottomNavProjects = (project) => {
  ...
  const taskFormContainer = document.querySelector('.form-container');
  taskFormContainer.style.display = 'none';
  taskFormContainer.dataset.index = _objStuff_js__WEBPACK_IMPORTED_MODULE_2__.projectManager.getProjectIndex(project);
  ...
  const taskBtn = (0,_divTemplates_js__WEBPACK_IMPORTED_MODULE_0__.taskButtonTemplate)();
...
const displayBottomNavDivs = () => {
  ...
  _objStuff_js__WEBPACK_IMPORTED_MODULE_2__.projectManager.getProjects().forEach((project, index) => {
    const projectDiv = (0,_divTemplates_js__WEBPACK_IMPORTED_MODULE_0__.bottomNavDivTemplate)(project.name, index);
    bottomNav.insertBefore(projectDiv, form);

    projectDiv.addEventListener('click', (e) => {
      (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.removeNotNeeded)();
      displayBottomNavProjects(project);
      (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.handleSelections)(e);
    });

    const closeBtn = document.querySelector(`#close[data-index="${index}"]`);
    closeBtn.addEventListener('click', (e) => {
      e.stopPropagation();
      _objStuff_js__WEBPACK_IMPORTED_MODULE_2__.projectManager.deleteProject(index);
      (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.saveStorage)();
      (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.clearBottomNavDivDisplay)();
...
const bottomNavStuff = (() => {
  ...
  formSubmit.addEventListener('click', () => {
    const project = (0,_objStuff_js__WEBPACK_IMPORTED_MODULE_2__.projectFactory)(projectName.value);
    _objStuff_js__WEBPACK_IMPORTED_MODULE_2__.projectManager.addProject(project);
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.saveStorage)();
    addProjectForm.reset();
    addProjectForm.style.display = 'none';
    (0,_helpers_js__WEBPACK_IMPORTED_MODULE_1__.clearBottomNavDivDisplay)();
...
/* harmony export */   "bottomNavDivTemplate": () => (/* binding */ bottomNavDivTemplate)
/* harmony export */ });
...
/* harmony import */ var _images_close_thick_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./images/close-thick.svg */ "./src/images/close-thick.svg");
...
const taskTemplate = (task, idx) => {
  ...
  if (task.dueDate === '') {
    ...
    date.textContent = `Due: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.dueDate, 'MM-dd-yyyy')}`;
  }
  rightSide.appendChild(date);

  const closeImg = new Image();
  closeImg.src = _images_close_thick_svg__WEBPACK_IMPORTED_MODULE_1__;
...
/* harmony export */   "handleSelections": () => (/* binding */ handleSelections),
/* harmony export */   "load": () => (/* binding */ load),
/* harmony export */   "removeNotNeeded": () => (/* binding */ removeNotNeeded),
/* harmony export */   "clearBottomNavDivDisplay": () => (/* binding */ clearBottomNavDivDisplay)
/* harmony export */ });
/* harmony import */ var _objStuff_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./objStuff.js */ "./src/objStuff.js");
/* harmony import */ var _bottomNavStuff_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bottomNavStuff.js */ "./src/bottomNavStuff.js");
/* harmony import */ var _topNavStuff__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./topNavStuff */ "./src/topNavStuff.js");
...
const saveStorage = () => {
  let projects = JSON.stringify(_objStuff_js__WEBPACK_IMPORTED_MODULE_0__.projectManager.getProjects());
...
const load = () => {
  if(!localStorage.getItem('projects')) {
    (0,_topNavStuff__WEBPACK_IMPORTED_MODULE_2__.allTasksDisplay)();
  } else {
    ...
    projects.forEach((project) => {
      const proj = (0,_objStuff_js__WEBPACK_IMPORTED_MODULE_0__.projectFactory)(project.name);

      project.tasks.forEach((task) => {
        const tsk = (0,_objStuff_js__WEBPACK_IMPORTED_MODULE_0__.taskFactory)(task.title, task.description, new Date(task.dueDate), task.important, task.finished);
        proj.addTask(tsk);
      })

      _objStuff_js__WEBPACK_IMPORTED_MODULE_0__.projectManager.addProject(proj);
    });
  };
  (0,_bottomNavStuff_js__WEBPACK_IMPORTED_MODULE_1__.displayBottomNavDivs)();
  (0,_topNavStuff__WEBPACK_IMPORTED_MODULE_2__.allTasksDisplay)();
};
...
/* harmony export */ });
/* harmony import */ var _objStuff_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./objStuff.js */ "./src/objStuff.js");
/* harmony import */ var _divTemplates_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./divTemplates.js */ "./src/divTemplates.js");
...
/* harmony import */ var _images_starOutline_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./images/starOutline.svg */ "./src/images/starOutline.svg");
/* harmony import */ var _images_starFilled_svg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./images/starFilled.svg */ "./src/images/starFilled.svg");
...
const bottomCloseBtnListener = (project, index) => {
  const closeTaskImg = document.querySelector(`#close-task[data-index="${index}"]`);
    closeTaskImg.addEventListener('click', (e) => {
      ...
      (0,_helpers_js__WEBPACK_IMPORTED_MODULE_2__.saveStorage)();
      (0,_helpers_js__WEBPACK_IMPORTED_MODULE_2__.clearTasks)();
...
const topCloseBtnListener = (project, task, index) => {
  const closeTaskImg = document.querySelector(`#close-task[data-index="${index}"]`);
    closeTaskImg.addEventListener('click', (e) => {
      e.stopPropagation();
      _objStuff_js__WEBPACK_IMPORTED_MODULE_0__.projectManager.getProjects().forEach((pmProject) => {
...
const taskDisplay = (project, bottom = false) => {
  ...
  project.getTasks().forEach((task, index) => {
    const taskDiv = (0,_divTemplates_js__WEBPACK_IMPORTED_MODULE_1__.taskTemplate)(task, index);
    tasksDiv.appendChild(taskDiv);

    const descriptionDiv = (0,_divTemplates_js__WEBPACK_IMPORTED_MODULE_1__.taskDescriptionTemplate)(task, index);
    ...
    if (task.important === true) {
      starImg.src = _images_starFilled_svg__WEBPACK_IMPORTED_MODULE_6__;
    } else {
      starImg.src = _images_starOutline_svg__WEBPACK_IMPORTED_MODULE_5__;
    }
    ...
    starImg.addEventListener('click', (e) => {
      e.stopPropagation();
      starImg.src === _images_starFilled_svg__WEBPACK_IMPORTED_MODULE_6__ ? starImg.src = _images_starOutline_svg__WEBPACK_IMPORTED_MODULE_5__ : starImg.src = _images_starFilled_svg__WEBPACK_IMPORTED_MODULE_6__;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (taskDisplay);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "topNavStuff": () => (/* binding */ topNavStuff),
/* harmony export */   "allTasksDisplay": () => (/* binding */ allTasksDisplay)
/* harmony export */ });
/* harmony import */ var _objStuff_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./objStuff.js */ "./src/objStuff.js");
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers.js */ "./src/helpers.js");
/* harmony import */ var _taskDisplay_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taskDisplay.js */ "./src/taskDisplay.js");
...
/* harmony import */ var date_fns_isSameWeek__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns/isSameWeek */ "./node_modules/date-fns/esm/isSameWeek/index.js");
...
const topNavDisplayHandler = (project) => {
  ...
  (0,_taskDisplay_js__WEBPACK_IMPORTED_MODULE_2__["default"])(project);
};


// sets up the all tasks project using project manager
const allTasksDisplay = () => {
  const allTasksProject = (0,_objStuff_js__WEBPACK_IMPORTED_MODULE_0__.projectFactory)('allTasks');

  _objStuff_js__WEBPACK_IMPORTED_MODULE_0__.projectManager.getProjects().forEach((project) => {
...
const todayTasksDisplay = () => {
  ...
  const todayTasksProject = (0,_objStuff_js__WEBPACK_IMPORTED_MODULE_0__.projectFactory)('Today');

  _objStuff_js__WEBPACK_IMPORTED_MODULE_0__.projectManager.getProjects().forEach((project) => {
    project.getTasks().forEach((task) => {
      if ((0,date_fns_isSameDay__WEBPACK_IMPORTED_MODULE_3__["default"])(today, task.dueDate)) {
...
const thisWeeksDisplay = () => {
  const today = new Date()
  const thisWeeksProject = (0,_objStuff_js__WEBPACK_IMPORTED_MODULE_0__.projectFactory)('This Week');

  _objStuff_js__WEBPACK_IMPORTED_MODULE_0__.projectManager.getProjects().forEach((project) => {
    project.getTasks().forEach((task) => {
      if ((0,date_fns_isSameWeek__WEBPACK_IMPORTED_MODULE_4__["default"])(today, task.dueDate)) {
...
const importantTasksDisplay = () => {
  const importantTasksProject = (0,_objStuff_js__WEBPACK_IMPORTED_MODULE_0__.projectFactory)('Important');
...
module.exports = __webpack_require__.p + "c971959880c52cf62b31.svg";
...
module.exports = __webpack_require__.p + "67ada79953b43d015ed8.svg";

/***/ }),

/***/ "./src/images/starOutline.svg":
/*!************************************!*\
  !*** ./src/images/starOutline.svg ***!
  \************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "a9658650b00ef160ba2b.svg";
