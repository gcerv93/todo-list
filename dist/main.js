...
const handleFormSubmits = () => {
  ...
  const task = (0,_factories_js__WEBPACK_IMPORTED_MODULE_2__.taskFactory)(taskName.value, desc.value, (0,date_fns_parse__WEBPACK_IMPORTED_MODULE_5__["default"])(dueDate.value, 'yyyy-MM-dd', new Date()), false, false);
...
const todayTasksDisplay = () => {
  ...
  _projectManager_js__WEBPACK_IMPORTED_MODULE_0__["default"].getProjects().forEach((project) => {
    project.getTasks().forEach((task) => {
      if ((0,date_fns_isSameDay__WEBPACK_IMPORTED_MODULE_5__["default"])(today, task.dueDate)) {
