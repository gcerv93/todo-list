...
const thisWeeksDisplay = () => {
  ...
  _projectManager_js__WEBPACK_IMPORTED_MODULE_0__["default"].getProjects().forEach((project) => {
    project.getTasks().forEach((task) => {
      console.log((0,date_fns_isSameWeek__WEBPACK_IMPORTED_MODULE_6__["default"])(today, task.dueDate));
      if ((0,date_fns_isSameWeek__WEBPACK_IMPORTED_MODULE_6__["default"])(today, task.dueDate)) {
