...
const handleFormSubmits = () => {
  ...
  const task = (0,_factories_js__WEBPACK_IMPORTED_MODULE_2__.taskFactory)(taskName.value, desc.value, (0,date_fns_parse__WEBPACK_IMPORTED_MODULE_7__["default"])(dueDate.value, 'yyyy-MM-dd', new Date()), false, false);
...
/* harmony import */ var _images_starOutline_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./images/starOutline.svg */ "./src/images/starOutline.svg");
...
const taskTemplate = (task, idx) => {
  ...
  starImg.src = _images_starOutline_svg__WEBPACK_IMPORTED_MODULE_3__;
  ...
  if (task.dueDate === '') {
    ...
    date.textContent = `Due: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(task.dueDate, 'MM-dd-yyyy')}`;
  }
...
/* harmony import */ var date_fns_isSameWeek__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! date-fns/isSameWeek */ "./node_modules/date-fns/esm/isSameWeek/index.js");
/* harmony import */ var _images_starOutline_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./images/starOutline.svg */ "./src/images/starOutline.svg");
/* harmony import */ var _images_starFilled_svg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./images/starFilled.svg */ "./src/images/starFilled.svg");
...
const todayTasksDisplay = () => {
  ...
  const todayTasksProject = (0,_factories_js__WEBPACK_IMPORTED_MODULE_1__.projectFactory)('Today');

  _projectManager_js__WEBPACK_IMPORTED_MODULE_0__["default"].getProjects().forEach((project) => {
    project.getTasks().forEach((task) => {
      if ((0,date_fns_isSameDay__WEBPACK_IMPORTED_MODULE_7__["default"])(today, task.dueDate)) {
...
const thisWeeksDisplay = () => {
  const today = new Date()
  const thisWeeksProject = (0,_factories_js__WEBPACK_IMPORTED_MODULE_1__.projectFactory)('This Week');

  _projectManager_js__WEBPACK_IMPORTED_MODULE_0__["default"].getProjects().forEach((project) => {
    project.getTasks().forEach((task) => {
      console.log((0,date_fns_isSameWeek__WEBPACK_IMPORTED_MODULE_8__["default"])(today, task.dueDate));
      if ((0,date_fns_isSameWeek__WEBPACK_IMPORTED_MODULE_8__["default"])(today, task.dueDate)) {
...
const importantTasksDisplay = () => {
  const importantTasksProject = (0,_factories_js__WEBPACK_IMPORTED_MODULE_1__.projectFactory)('Important');
